...
public interface WishlistRepository extends JpaRepository<Wishlist, UUID> {
    ...
    /** Obtiene la primera lista del usuario (la predeterminada, orden por fecha de creación). */
    java.util.Optional<Wishlist> findFirstByUserIdOrderByCreatedAtAsc(UUID userId);
}
