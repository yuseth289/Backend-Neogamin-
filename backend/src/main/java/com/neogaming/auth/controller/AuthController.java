...
import com.neogaming.auth.dto.request.GoogleAuthRequest;
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<TokenResponse>> googleLogin(
            ...
            HttpServletRequest httpRequest) {
        String deviceInfo = httpRequest.getHeader("User-Agent");
        TokenResponse tokens = authService.googleLogin(request.idToken(), deviceInfo);
        return ResponseEntity.ok(ApiResponse.ok("Inicio de sesión con Google exitoso", tokens));
    }
