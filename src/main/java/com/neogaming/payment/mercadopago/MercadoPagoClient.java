...
public class MercadoPagoClient {
    ...
    /** URL del webhook de NeoGaming para recibir notificaciones de MP */
    @Value("${app.base-url:http://localhost:8080}/webhooks/mercadopago")
    private String webhookUrl;

    /** URL de retorno tras el pago exitoso */
    @Value("${app.base-url:http://localhost:8080}/checkout/success")
    private String successUrl;

    /** URL de retorno cuando el usuario cancela en MP */
    @Value("${app.base-url:http://localhost:8080}/checkout/cancel")
    ...
    public MercadoPagoPreferenceResponse crearPreferencia(
        ...
        // URL del webhook de notificaciones
        ...
        log.info("Creando preferencia de pago en MP para checkout: {}", checkoutId);
     ...
     * El access token se envía en el header Authorization como Bearer.
     *
     * @return HttpHeaders con Content-Type y Authorization configurados
     */
